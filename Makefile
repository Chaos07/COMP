...
ANTLR_JAR=~/COMP/antlr/antlr-3.5.jar
...
parser: $(G)Lexer.class $(G)Parser.class $(G).class
...
$(G)Parser.java: $(G).g
	java -cp $(ANTLR_JAR):. org.antlr.Tool $(G).g

# This rule updates the ANTLR-generated Lexer whenever the parser or the
# lexer grammars are modified.
$(G)Lexer.java: $(G).g
	java -cp $(ANTLR_JAR):. org.antlr.Tool $(G).g
